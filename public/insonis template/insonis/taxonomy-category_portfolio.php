 ...
 */
	...
	$columns_lg = insonis_get_option('portfolio_columns_lg', '4');
	$columns_md = insonis_get_option('portfolio_columns_md', '3');
	$columns_sm = insonis_get_option('portfolio_columns_sm', '2');
	$columns_xs = insonis_get_option('portfolio_columns_xs', '1');
