...
<?php if($style == 'style-1'){ ?>
	<div class="team-one elementor-repeater-item-<?php echo $item['_id'] ?>">
		<?php 
			if($image_url){ 
...
<?php if($style == 'style-2'){ ?>
	<div class="team-two elementor-repeater-item-<?php echo $item['_id'] ?>">
		<?php 
			if($image_url){ 
				echo '<div class="team-two__image">';
					echo $this->gva_render_link_html($image, $item['link'], 'link-content'); 
					echo '<div class="team-two__social">';
						echo '<div class="team-two__social-control"><i class="fas fa-share-alt"></i></div>';
