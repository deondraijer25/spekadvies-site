         ...
         <div class="video-one__inner">
            ...
            <div class="video-one__content">
               <div class="video-one__action">
                  <?php 
                     echo '<a ' . $this->get_render_attribute_string( 'link' ) . '><i class="iicon-play-1"></i></a>';
                  ?>  
               </div>   
            </div>    
         </div>
         ...
         <div class="video-two__inner">
            <div class="video-two__content">
               <div class="video-two__action">
                  <a <?php echo $this->get_render_attribute_string( 'link' ) ?>><span><i class="iicon-play-1"></i></span></a>
               </div>
