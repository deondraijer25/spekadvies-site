   ...
   <?php if( $style == 'style-1' || $style == 'style-1a'){ ?>
      <div class="testimonial-one__single<?php echo ($style=='style-1a' ? ' skin-white' : '') ?>">
         <div class="testimonial-one__quote">
            ...
            <span class="testimonial-one__quote-icon"><i class="iicon-testimonial"></i></span>
            ...
            <?php 
               if($avatar){ 
                  echo '<div class="testimonial-one__image">';
                     echo '<img ' . $this->insonis_get_image_size($avatar) . ' src="' . esc_url($avatar) . '" alt="' . $item['testimonial_name'] . '" />';
                  echo '</div>';
               }
            ?>
   ...
   <?php if( $style == 'style-2'){ ?>
      <div class="testimonial-two">
         <div class="testimonial-two__content">
            <div class="testimonial-two__icon"><i class="iicon-quote"></i></div>
   ...
   <?php if( $style == 'style-3'){ ?>
      <div class="testimonial-three__single">
         <div class="testimonial-three__content">
            <span class="testimonial-three__quote-icon"><i class="iicon-quote"></i></span>
