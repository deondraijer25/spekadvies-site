...
<?php if($skin == 'skin-v1'){ ?>
	<div class="about-one">
		<div class="about-one__bg"></div>
		<div class="about-one__arrow"></div>
		<div class="about-one__mask"></div>
		<?php 
	  	...
	  	<?php 
	  		if( !empty($settings['image']['url']) ){
			 	echo '<div class="about-two__image">';
				  	...
				  	echo '<img src="' . esc_url($image_url) .'" alt="'. esc_attr($settings['title_text']) . '" />';
				  	$this->gva_render_link_html('', $settings['link'], 'about-two__link-overlay'); 
		 		echo '</div>';
	  		} 
	  		if( !empty($settings['image_second']['url']) ){
			 	echo '<div class="about-two__image-second">';
					echo '<div class="content-inner">';
					 	...
					 	echo '<img src="' . esc_url($image_url_second) .'" alt="'. esc_attr($settings['title_text']) . '" />';
				  		$this->gva_render_link_html('', $settings['link'], 'about-two__link-overlay'); 
					echo '</div>';
			 	echo '</div>';
		 	}
		 	if(!empty($settings['image_three']['url'])){
	 			echo '<div class="about-two__image-three">';
	 				echo '<img src="'.esc_url($settings['image_three']['url']).'" alt="'. esc_attr($settings['title_text']) . '" />';
	 				$this->gva_render_link_html('', $settings['link'], 'about-two__link-overlay'); 
	 			echo '</div>';
	 		}
	...
	<div class="about-three">
		<div class="about-three__wrap">
		  	<?php 
		  		...
		  		if( $settings['title_text'] ){
		 			echo '<div class="about-three__content">';
		 				echo '<div class="about-three__stars">';
		 					echo '<i class="iicon-star-2"></i>';
		 					echo '<i class="iicon-star-2"></i>';
		 					echo '<i class="iicon-star-2"></i>';
		 					echo '<i class="iicon-star-2"></i>';
		 					echo '<i class="iicon-star-2"></i>';
		...
		<div class="about-three__icon"><i class="iicon-quote"></i></div>
  	...
  	<div class="about-five">
  		<div class="about-five__wrap">
		 	<?php 
	 			...
	 			echo '<div class="about-five__content">';
		 	...
		 	<?php 
				if( $settings['title_text'] ){
		 			echo '<div class="about-six__content">';
		 				if($settings['title_text']){
		 					echo '<div class="about-six__title">' . esc_html($settings['title_text']) . '</div>';
		 				}
		 			echo '</div>';
		 		}
		 	?>
	  	...
	  	<?php 
	  		if( !empty($settings['image']['url']) ){
			 	echo '<div class="about-seven__image">';
				  	$image_url = $settings['image']['url']; 
				  	echo '<img src="' . esc_url($image_url) .'" alt="'. esc_attr($settings['title_text']) . '" />';
				  	$this->gva_render_link_html('', $settings['link'], 'about-seven__link-overlay'); 
		 		echo '</div>';
	  		} 
		 	if(!empty($settings['image_three']['url'])){
	 			echo '<div class="about-seven__image-three">';
	 				echo '<img src="'.esc_url($settings['image_three']['url']).'" alt="'. esc_attr($settings['title_text']) . '" />';
	 				$this->gva_render_link_html('', $settings['link'], 'about-seven__link-overlay'); 
	 			echo '</div>';
	 		}
	  		if( $settings['title_text'] || $settings['description_text'] ){
	 			echo '<div class="about-seven__box-content">';
 					if($settings['title_text']){
	 					echo '<div class="about-seven__title">' . htmlspecialchars($settings['title_text']) . '</div>';
	 				}
	 				if($settings['description_text']){
	 					echo '<div class="about-seven__desc">' . htmlentities($settings['description_text']) . '</div>';
	 				}
	 			echo '</div>';
	 		}
		?>
