(function ($) {
	"use strict";
  	var GaviasElements = {
	 	...
	 	backend: function(){
	 		elementor.settings.page.addChangeCallback( 'insonis_post_preview', GaviasElements.handlePostPreview);
	 	},
		...
		elementColumn: function($scope){
			...
			if(($scope).hasClass('gv-sidebar-offcanvas')){
				var html = '<div class="control-mobile">';
		         	html += '<a class="control-mobile-link" href="#"><i class="iicon-bars"></i>Show Sidebar<a>';
		         html += '</div>';
				$scope.append(html);
