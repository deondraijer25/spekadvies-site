...
class GVAElement_Heading_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Heading Block', 'insonis-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Add Your Heading Text Here', 'insonis-themer' ),
				'label_block' => true
			]
		);
		...
		$this->add_control(
			'align',
			[
				'label' => __( 'Alignment Text', 'insonis-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'insonis-themer' ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', 'insonis-themer' ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', 'insonis-themer' ),
		...
		$this->add_control(
			'box_align',
			[
				'label' => __( 'Alignment Box', 'insonis-themer' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', 'insonis-themer' ),
		...
		$this->add_responsive_control(
			'max_width',
			[
				'label' => __( 'Max Width (px)', 'insonis-themer' ),
		...
		$this->add_control(
			'auto_responsive',
			[
				'label' => __( 'Auto Responsive', 'insonis-themer' ),
				'type' => Controls_Manager::SWITCHER,
				'placeholder' => __( 'Auto Responsive size of title', 'insonis-themer' ),
				'default' => 'yes'
			]
		);
		...
		$this->start_controls_section( //** Section Icon
			'section_video',
			[
				'label' => __( 'Video Top', 'insonis-themer' ),
			]
		);
		$this->add_control(
			'video',
			[
				'label' 			=> __( 'Video', 'insonis-themer' ),
				'type' 			=> Controls_Manager::SWITCHER,
				'placeholder' 	=> __( 'Enable/Disable Video Heading', 'insonis-themer' ),
				'default' 		=> 'no'
			]
		);
		$this->add_control(
			'video_url',
			[
				'label' 			=> __( 'Video Youtube or Vimeo URL', 'insonis-themer' ),
				'label_block'	=> true,
				'type' 			=> Controls_Manager::TEXT,
				'condition' => [
					'video' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'btn-border' 			=> esc_html__('Button Border', 'insonis-themer'),
					'btn-border-white' 	=> esc_html__('Button Border White', 'insonis-themer')
				],
				'default' => 'btn-theme',
			]
		);
		$this->add_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'insonis-themer' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' 					=> esc_html__('Button Size Default', 'insonis-themer'),
					'btn-size-small' 	=> esc_html__('Button Small', 'insonis-themer'),
					'btn-medium' 		=> esc_html__('Button Medium', 'insonis-themer')
				],
				'default' => '',
			]
		);
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Text Color', 'insonis-themer' ),
		...
		$this->add_control(
			'button_background',
			[
				'label' => __( 'Button Background', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color_hover',
			[
				'label' => __( 'Button Color Hover', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Button Background Hover', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_video_style',
			[
				'label' => __( 'Video Button', 'insonis-themer' ),
		...
		$this->add_control(
			'video_color',
			[
				'label' => __( 'Text Button Video Color', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'video_size',
			[
				'label' => __( 'Video Button Size', 'insonis-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 92,
				],
		...
		$this->add_responsive_control(
			'box_space',
			[
				'label' => __( 'Heading Element Space Bottom', 'insonis-themer' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			'title_space',
			[
				'label' => __( 'Title Spacing', 'insonis-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sub Title Icon Color', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .gsc-heading .sub-title .tagline:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'sub_title_space',
			[
				'label' => __( 'Sub Title Spacing', 'insonis-themer' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 8,
				],
		...
		$this->add_responsive_control(
			'description_space',
			[
				'label' => __( 'Description Spacing', 'insonis-themer' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px'],
				'default' => [
              'top'       => 20,
