...
class GVA_Elementor_Override{
   ...
   public function __construct() {
      ...
      add_action( 'elementor/editor/after_save', array($this, 'clear_cache_updating_elementor') );
		add_filter( 'elementor/widget/render_content', array($this, 'remove_attribute_from_content'), 10, 2 );
   ...
   function elementor_init_setup(){
	...
	public function remove_attribute_from_content( $content, $widget ) {
	   if ('nested-accordion' === $widget->get_name()) {
	    	$content = str_replace( 'aria-expanded="true"', '', $content );
	    	$content = str_replace( 'aria-expanded="false"', '', $content );
	    	$content = str_replace( 'aria-label="Accordion. Open links with Enter or Space, close with Escape, and navigate with Arrow Keys"', '', $content );
	    	$content = str_replace( 'aria-label="' . esc_attr__('Accordion. Open links with Enter or Space, close with Escape, and navigate with Arrow Keys', 'insonis-themer').'"', '', $content );
	    }
	   return $content;
	}
   ...
   public function column_control($obj, $args){
      ...
      $obj->start_controls_section(
         'gva_column_control',
         array(
            'label' => esc_html__( 'Other Settings', 'insonis-themer' ),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Inner Width', 'insonis-themer'),
   ...
   public function after_row_end( $obj, $args ) {
      $obj->start_controls_section(
         'gva_section_row',
         array(
            'label' => esc_html__( 'Gavias Extra Settings Row for Header Builder', 'insonis-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'insonis-themer' ),
      ...
      $obj->add_control(
         '_gva_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'insonis-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'insonis-themer' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'insonis-themer' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'insonis-themer'),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'insonis-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'insonis-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'insonis-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'Gavias Style Settings', 'insonis-themer' ),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __( 'Style Available', 'insonis-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''                 => __( '-- None --', 'insonis-themer' ),
            ],
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'insonis-themer' ),
               'theme'         => __( 'Background Color Theme', 'insonis-themer' ),
               'theme-second'  => __( 'Background Color Theme Second', 'insonis-themer' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
