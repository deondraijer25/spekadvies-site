...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('Testimonials', 'insonis-themer');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'insonis-themer'),
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1'  => esc_html__('Item Style 01', 'insonis-themer'),
                  'style-1a' => esc_html__('Item Style 01 White', 'insonis-themer'),
                  'style-2'  => esc_html__('Item Style 02', 'insonis-themer'),
                  'style-3'  => esc_html__('Item Style 03', 'insonis-themer')
                ]
            )
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_INSONIS_PLUGIN_URL . 'elementor/assets/images/testimonial.jpg',
                ],
        ...
        $this->add_control(
            'testimonials',
            [
                'label'       => __('Testimonials Content Item', 'insonis-themer'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'title_field' => '{{{ testimonial_name }}}',
                'default'     => array(
                    array(
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'insonis-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'insonis-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Kevin Smith', 'insonis-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'insonis-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Jessica Brown', 'insonis-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'insonis-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'David Anderson', 'insonis-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'insonis-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'insonis-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'insonis-themer' ),
                    ),
                ),
            ]
