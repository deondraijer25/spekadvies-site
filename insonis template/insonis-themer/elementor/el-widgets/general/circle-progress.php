...
class GVAElement_Circle_Progress extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Circle Progress', 'insonis-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'	  => esc_html__( 'Organic Foods Provides', 'insonis-themer' )
			]
		);
		$this->add_control(
			'empty_fill',
			[
				'label' => __( 'Color EmptyFill', 'insonis-themer' ),
		...
		$this->add_control(
			'number',
			[
			  	'label' => __( 'Percentage', 'insonis-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 5,
			  	'max' => 100,
			  	'step' => 1,
	 	...
	 	$this->add_control(
			'thickness',
			[
			  	'label' => __( 'Thickness', 'insonis-themer' ),
			  	'type' => Controls_Manager::NUMBER,
				'min' => 1,
			  	'max' => 50,
			  	'step' => 1,
		...
		$this->add_control(
			'percentage_color',
			[ 
				'label' => __( 'Percentage Color', 'insonis-themer' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
