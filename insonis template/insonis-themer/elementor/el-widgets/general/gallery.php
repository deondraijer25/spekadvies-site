...
class GVAElement_Gallery extends GVAElement_Base{
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __('Gallery', 'insonis-themer');
	}
	...
	protected function register_controls() {
      ...
      $repeater->add_control(
         ...
         [
            ...
            'default' => esc_html__('Luxury Interior', 'insonis-themer'),
		...
		$repeater->add_control(
         ...
         [
            ...
            'default' => esc_html__('Insurance', 'insonis-themer'),
            'type'    => Controls_Manager::TEXT,
         ]
     	);
		...
		$this->add_control(
         ...
         [
            ...
            'default'     => array(
                  ...
                  'sub_title' => esc_html__('Insurance', 'insonis-themer')
              	),
               array(
                  'image'    => [
                     'url' => GAVIAS_INSONIS_PLUGIN_URL . 'elementor/assets/images/gallery-2.jpg',
                  ],
               ...
               array(
                  'image'    => [
                     'url' => GAVIAS_INSONIS_PLUGIN_URL . 'elementor/assets/images/gallery-3.jpg',
                  ],
               ...
               array(
                  'image'    => [
                     'url' => GAVIAS_INSONIS_PLUGIN_URL . 'elementor/assets/images/gallery-4.jpg',
                  ],
                  'title' => esc_html__('Marriage insurance', 'insonis-themer'),
                  'sub_title' => esc_html__('Insurance', 'insonis-themer')
              	),
               array(
                  'image'    => [
                     'url' => GAVIAS_INSONIS_PLUGIN_URL . 'elementor/assets/images/gallery-5.jpg',
                  ],
                  'title' => esc_html__('Travel insurance', 'insonis-themer'),
                  'sub_title' => esc_html__('Insurance', 'insonis-themer')
              	),
            )
         ]
		...
		$this->add_control(
			...
			[
				...
				'options' => [
          'style-1'           => __( 'Gallery Style 01', 'insonis-themer' ),
					'style-2'           => __( 'Gallery Style 02', 'insonis-themer' )
				],
				'default' => 'style-1',
			]
		);
