...
class GVAElement_Career_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Career Block', 'insonis-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Categories', 'insonis-themer' ),
				'label_block' => true
			]
		);
		$this->add_control(
			'job_content',
			[
				'label' => __( 'Job Type', 'insonis-themer' ),
		...
		$this->add_control(
			'company',
			[
				'label' => __( 'Company', 'insonis-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'address',
			[
				'label' => __( 'Address', 'insonis-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'insonis-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
