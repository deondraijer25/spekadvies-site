...
class GVAElement_Features_Block extends GVAElement_Base {  
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Features Block', 'insonis-themer' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => __( 'Features Block', 'insonis-themer' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Safe your money', 'insonis-themer' ),
		...
		$this->add_control(
			...
			[
				'label' => '',
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'Lorem ipsum dolor amet consectetur adipiscing elit do eiusmod tempor incid idunt ut labore.', 'insonis-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( '01', 'insonis-themer' ),
				'placeholder' => __( 'Enter your number', 'insonis-themer' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'btn-theme-3' 			=> esc_html__('Button Theme Third', 'insonis-themer'),
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .feature-one__icon-box i, {{WRAPPER}} .feature-two__icon i, {{WRAPPER}} .feature-three__icon-box i' => 'color: {{VALUE}}!important;',
					'{{WRAPPER}} .feature-one__icon-box svg, {{WRAPPER}} .feature-two__icon svg, {{WRAPPER}} .feature-three__icon-box svg' => 'fill: {{VALUE}}!important;'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .feature-one__icon-box i, {{WRAPPER}} .feature-two__icon i, {{WRAPPER}} .feature-three__icon-box i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .feature-one__icon-box svg, {{WRAPPER}} .feature-two__icon svg, {{WRAPPER}} .feature-three__icon-box svg' => 'width: {{SIZE}}{{UNIT}};'
				],
			]
		);
