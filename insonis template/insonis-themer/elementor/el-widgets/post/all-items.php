...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'insonis-themer');
	 }
	 ...
	 private function get_categories_list(){
		  ...
		  $categories['none'] = __('None', 'insonis-themer');
		  $taxonomy = 'category';
	 ...
	 private function get_posts() {
		  ...
		  $posts['none'] = __('None', 'insonis-themer');
	 ...
	 protected function register_controls() {
		  $this->start_controls_section(
				'section_query',
				[
					 'label' => __('Query & Layout', 'insonis-themer'),
		  ...
		  $this->add_control( // xx Layout
				'layout_heading',
				[
					 'label'   => __('Layout', 'insonis-themer'),
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'insonis-themer'),
						  'grid'          => __('Grid', 'insonis-themer'),
						  'carousel'      => __('Carousel', 'insonis-themer'),
						  'list'    		=> __('List', 'insonis-themer'),
						  'sticky'        => __('Post Large & List', 'insonis-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'insonis-themer'),
						  'post-style-2'         => __('Item Post Style II', 'insonis-themer'),
						  'post-style-3'         => __('Item Post Style III', 'insonis-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->add_control(
				'image_size',
				[
					'label'     => __('Image Style', 'insonis-themer'),
					'type'      => \Elementor\Controls_Manager::SELECT,
					'options'   => $this->get_thumbnail_size(),
					'default'   => 'insonis_medium'
				]
		  	);
		  	$this->add_control(
				'excerpt_words',
				[
					'label'     => __('Excerpt Words', 'insonis-themer'),
					'type'      => 'number',
					'default'   => 15
				]
		  	);
		  	...
		  	$this->add_control(
				'category_ids',
				[
					'label' => __('Select By Category', 'insonis-themer'),
		  	...
		  	$this->add_control(
				'post_ids',
				[
					'label' => __('Select Individually', 'insonis-themer'),
					'type' => Controls_Manager::SELECT2,
					'default' => '',
					'multiple'    => true,
					'label_block' => true,
		  	...
		  	$this->add_control(
				'posts_per_page',
				[
					'label' => __('Posts Per Page', 'insonis-themer'),
		  	...
		  	$this->add_control(
				'orderby',
				[
					'label'   => __('Order By', 'insonis-themer'),
					'type'    => Controls_Manager::SELECT,
					'default' => 'post_date',
					'options' => [
					  	'post_date'  => __('Date', 'insonis-themer'),
					  	'post_title' => __('Title', 'insonis-themer'),
					  	'menu_order' => __('Menu Order', 'insonis-themer'),
					  	'rand'       => __('Random', 'insonis-themer'),
					]
				]
		  	);
		  	...
		  	$this->add_control(
				'order',
				[
					'label'   => __('Order', 'insonis-themer'),
					'type'    => Controls_Manager::SELECT,
					'default' => 'desc',
					'options' => [
					  'asc'  => __('ASC', 'insonis-themer'),
					  'desc' => __('DESC', 'insonis-themer'),
					]
				]
		  	);
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'insonis-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'insonis-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'insonis-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'insonis-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'insonis-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Post Content', 'insonis-themer'),
					'tab'   => Controls_Manager::TAB_STYLE,
					'condition' => [
		  	...
		  	$this->add_responsive_control(
				'post_box_padding',
				[
					'label' => __('Padding Post Content', 'insonis-themer'),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
		  ...
		  $this->add_control(
				'post_box_background',
				[
					 'label' => __('Background Post Content', 'insonis-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Title', 'insonis-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title', 'insonis-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title Hover', 'insonis-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'insonis-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
