...
class Insonis_Themer_Widget_Recent_Posts extends WP_Widget {
   ...
   */
   ...
   public function widget( $args, $instance ) {
      ...
      $default_title = esc_html__( 'Recent Posts', 'insonis-themer' );
            ...
            <li>
               <div class="clearfix post-list-item <?php echo (has_post_thumbnail($recent_post->ID) ? 'has-thumbnail' : 'no-thumbnail' )  ?>">
                  ...
                  <div class="post-content">
                     <?php
                        $comments_number = get_comments_number_text( esc_html__('0 Comments', 'insonis-themer'), esc_html__('1 Comment', 'insonis-themer'), esc_html__('% Comments', 'insonis-themer'), $recent_post->ID);
                        printf( 
...
function insonis_themer_widget_recent_posts(){
   return register_widget('Insonis_Themer_Widget_Recent_Posts');
}

add_action('widgets_init', 'insonis_themer_widget_recent_posts');
