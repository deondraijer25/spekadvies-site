      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'insonis_header_position',
               [
                  'label'     => esc_html__('Header Position', 'insonis-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'insonis-themer'),
                     'absolute'  => esc_html__('Absolute', 'insonis-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'insonis-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'insonis_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'insonis-themer'),
                  'type'      => Controls_Manager::SELECT,
