...
<?php 
	...
	if(!isset($excerpt_words)){
		$excerpt_words = insonis_get_option('blog_excerpt_limit', 20);
	}
...
<div class="single-post-template">
	<?php do_action( 'insonis_page_breacrumb' ); ?>
								...
								<div class="content-inner">
									...
									<?php 
										echo '<div class="post-content clearfix">';
											the_content( sprintf(
												esc_html__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'insonis' ),
												the_title( '<span class="screen-reader-text">', '</span>', false )
											) );

											wp_link_pages( array(
												'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'insonis' ) . '</span>',
												'after'       => '</div>',
												'link_before' => '<span>',
												'link_after'  => '</span>',
											) );
									...
									<?php the_tags( '<footer class="entry-meta-footer"><span class="tag-links"><span class="tag-title">' . esc_html__( 'Tags:', 'insonis' ) . '</span>', '', '</span></footer>' ); ?>
